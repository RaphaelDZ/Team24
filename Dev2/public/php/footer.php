    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <br/>
                <i class=""></i> <strong>E-mail :</strong> <a href="mailto:contact@studenthood.fr">contact@studenthood.fr</a>
                <br/>
            </div>
            <div class="col-lg-3">
                <h3>Suivez-nous</h3>
        ...
        <div class="row footer-down">
            <div class="col-lg-10">
                <a href="index.php"><img src="img/logo-carre.png" alt="StudentHood" height="60px;" /></a> Copyright StudentHood 2016.
            </div>
