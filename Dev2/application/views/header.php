                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right text-uppercase">
                                ...
                                <li><a href="<?= base_url()?>index.php/blog/">Campus</a></li>
                                <li><a href="<?= base_url()?>index.php/blog/">Offres</a></li>
                                <li><a href="<?= base_url()?>index.php/blog/">Souscrire</a></li>
                                <li><a href="<?= base_url()?>index.php/blog/v_contact/">Contact</a></li>
                            </ul>
