<div id="site_content">
   <div id="content">
       ...
       <table width="100%">
           ...
           <td align="center"><!-- insert the page content here -->
               <?php if (!isset($post)) {
               ...
               {
                   ?>
                   <form action="<?= base_url() ?>index.php/comments/add_comment/<?= $post['post_id'] ?>"
                         method="post">
               ...
               ?>
               <a href="<?= base_url() ?>index.php/users/login">Connecte toi pour commenter</a>
           </td>
           <td></td>
       </table>
       <?php }
