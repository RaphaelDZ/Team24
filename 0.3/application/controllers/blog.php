...
{   
    ...
    function home_co($start = 0)
    {
        ...
        $config['base_url'] = base_url().'index.php/blog/home_co/';
    ...
    function new_post()
    {
        ...
        if($this->input->post())
        {
            ...
            redirect(base_url().'index.php/blog/home_co');
        }
        else{
            ...
            'upload_class'=>'',
            'contact_class'=>'');
            $data['categories'] = $this->m_db->get_category();
            $this->load->view('header',$class_name);
